...
_User administration_ is organised in an external component ({Keycloak}[Keycloak]),
...
Workspaces are used to organise access to collections. On workspace level there are two access levels:
